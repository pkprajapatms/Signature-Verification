...
I3=imnlmfilt(I3); %Non-local means filtering of image

I3=im2double(I3);   %converts the image I to double precision
...
%after rotating the image the signature might go out of the boundry therefore 
...
% Center of Gravities of the vertically divided images
